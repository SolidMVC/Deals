 ...
 */
namespace Deals\Models\Configuration;
use Deals\Models\Routing\RoutingInterface;
...
final class Configuration implements ConfigurationInterface
{
    ...
    public function __construct(
        ...
        //      Row: active_plugins
        //      Value (in JSON): <..>;i:0;s:32:"Deals/Deals.php";<..>
        ...
        // 1. __FILE__ => /GitHub/<REPOSITORY_NAME>/wp-content/plugins/Deals/Deals.php
        // 2. plugin_dir_path(__FILE__) => /GitHub/<REPOSITORY_NAME>/wp-content/plugins/Deals/ (with trailing slash at the end)
        // 3. plugin_basename(__FILE__) => Deals/Deals.php (used for active plugins list in WP database)
        // 4. dirname(plugin_basename((__FILE__)) => Deals
        // 5. basename($this->pluginPath) => Deals
        // 6. localLangRelPath used for load_textdomain, i.e. Deals/Languages/ (the correct example is WITH the ending trailing slash)
    ...
    /**
     * localLangRelPath used for load_textdomain (without slash at the end), i.e. Deals/Languages/Common
