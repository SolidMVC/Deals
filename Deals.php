...
use Deals\Models\Configuration\Configuration;
use Deals\Controllers\MainController;

if(!class_exists('Deals\Deals'))
{
    final class Deals
    {
        // Configuration
        ...
        private static $params = array(
            'plugin_prefix' => 'deals_',
            'plugin_handle_prefix' => 'deals-',
            'plugin_url_prefix' => 'deals-',
            'plugin_css_prefix' => 'deals-',
            'theme_ui_folder_name' => 'DealsUI', // Folder in your current theme path, that may override plugin’s UI
            'plugin_name' => 'Deals',
            'shortcode' => 'deals',
            'text_domain' => 'deals',
        );
    ...
    Deals::registerUninstallHook();

    // Run the plugin
    Deals::getMainController()->run();
}