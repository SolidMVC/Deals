 ...
 */
namespace Deals\Controllers\Front;
use Deals\Controllers\Front\Shortcodes\DealsController;
...
final class ShortcodeController
{
    ...
    public function parse(array $paramAttrArray)
    {
        ...
        {
            case "deals":
                // Create instance and render deals slider
                $objDealsController = new DealsController($this->conf, $this->lang, $paramArrLimits);
                $retContent = $objDealsController->getContent($sanitizedLayout, $validStyle);
                break;
