...
final class AssetController
{
	...
	public function registerScripts()
	{
        ...
        wp_register_script($this->conf->getPluginHandlePrefix().'main', $this->conf->getRouting()->getFrontJS_URL('DealsMain.js'), array('jquery'), '1.0', TRUE);
	}
